...
def plot_poly(geom, ax=None, color="C0", linestyle="--", linewidth=0.5, alpha=0.25):
    ...
    if geom.type == 'Polygon':
        ...
        ax.fill(x, y, color=color, edgecolor=None, alpha=alpha)
        ax.plot(x, y, color="black", linestyle=linestyle, linewidth=linewidth)

        for interior in geom.interiors:
            interior_coords = interior.coords[:]
            x, y = get_xy(interior_coords)
            ax.fill(x, y, color="white", edgecolor=None)
            ax.plot(x, y, color="black", linestyle=linestyle, linewidth=linewidth)
